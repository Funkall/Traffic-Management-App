...
# ===== 1. Backup Section (excluding node_modules) =====
$backupPath = "$base\__backup_$(Get-Date -Format 'yyyyMMdd_HHmmss')"
New-Item -ItemType Directory -Path $backupPath -Force

# Use Robocopy to avoid long path issues and exclude node_modules
robocopy $base $backupPath /E /XD "$base\frontend\node_modules" "$base\backend\node_modules" /R:1 /W:1
